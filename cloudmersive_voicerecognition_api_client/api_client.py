...
import cloudmersive_voicerecognition_api_client.models
from cloudmersive_voicerecognition_api_client import rest
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'Swagger-Codegen/4.1.0/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(cloudmersive_voicerecognition_api_client.models, klass)
